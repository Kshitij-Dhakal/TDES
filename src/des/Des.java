...
public class Des {
    ...
    public static void main(String[] args) {
        String message = "I have a secret to tell you";
        System.out.println("Original message :\t\t\t\t" + message);
        System.out.println("Original message (in hex) :\t\t" + Binary.binaryToHex(Binary.stringToBinary(message)));
        message = encrypt(new BigInteger("3123894546540383418119236010195353"), message);
        System.out.println("Encrypted message (in hex) :\t" + Binary.binaryToHex(message));
        message = decrypt(new BigInteger("3123894546540383418119236010195353"), message);
     ...
     */
    public static String encrypt(BigInteger key, String message) {
        String enc = "";
