...
public class KeyExpansion {
    ...
    //Each number in pc1 indicates the index of new bit in keys which will replace current bit.
...
/*
        for (int i = 0; i < 16; i++) {
            System.out.println("K" + (i + 1) + "\t=\t" + expandedKeys[i]);
        }
*/
        return expandedKeys;
    }
...
/*
    private static void checkPC1() {
        ...
        System.out.println("1111000 0110011 0010101 0101111 0101010 1011001 1001111 0001111");
        System.out.println(binaryKeys);
        System.out.println(binaryKeys.equals("1111000 0110011 0010101 0101111 0101010 1011001 1001111 0001111"));
    }
*/
